...
class _CurrentBookWidgetState extends State<CurrentBookWidget> {
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<BooksRecord>(
      stream: BooksRecord.getDocument(widget.bookDetail),
      builder: (context, snapshot) {
        ...
        final currentBookBooksRecord = snapshot.data;
        return Scaffold(
          key: scaffoldKey,
          appBar: AppBar(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Padding(
                    padding: EdgeInsetsDirectional.fromSTEB(16, 0, 0, 0),
                    child: Text(
                      'Name: ${currentBookBooksRecord.name}',
                      style: FlutterFlowTheme.bodyText1.override(
                        fontFamily: 'Montserrat',
                        color: Colors.white,
                      ),
                  ...
                  Padding(
                    padding: EdgeInsetsDirectional.fromSTEB(16, 0, 0, 0),
                    child: Text(
                      'Autor: ${currentBookBooksRecord.autor}',
                      style: FlutterFlowTheme.bodyText1.override(
                        fontFamily: 'Montserrat',
                        color: Colors.white,
                      ),
                  ...
                  Padding(
                    padding: EdgeInsetsDirectional.fromSTEB(16, 0, 0, 0),
                    child: Text(
                      'Description: ${currentBookBooksRecord.description}',
                      style: FlutterFlowTheme.bodyText1.override(
                        fontFamily: 'Montserrat',
                        color: Colors.white,
                      ),
