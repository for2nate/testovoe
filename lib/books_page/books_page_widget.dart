...
class BooksPageWidget extends StatefulWidget {
  BooksPageWidget({Key key}) : super(key: key);
                          ...
                          return InkWell(
                            onTap: () async {
                              await Navigator.push(
                                context,
                                MaterialPageRoute(
                                  builder: (context) => CurrentBookWidget(
                                    bookDetail: listViewBooksRecord.reference,
                                  ),
                                ),
                              );
                            },
